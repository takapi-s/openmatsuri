      ...
      <div className="w-full max-w-md">
        <div className="mb-6 flex flex-col items-center gap-3 text-center">
          <div className="inline-flex items-center gap-2 text-sm font-bold tracking-wide text-slate-700">
            ...
            <span className="text-indigo-600">Viewer</span>
          </div>
          <h1 className="text-2xl font-bold text-slate-900">来場者向けリアルタイムマップ</h1>
          <p className="text-sm font-medium text-slate-500">
            祭りの行列や施設の位置をリアルタイムで確認できます。
          </p>
        </div>

        <section className="rounded-lg border border-slate-200 bg-white p-6 shadow-sm">
          <Link href="/e/demo-matsuri">
